...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Jun-2023 às 14:36
...
CREATE TABLE `animal` (
  ...
  `FK_PASSAGEM` int(11) DEFAULT NULL,
  `DATA_NASC_PET` date DEFAULT NULL,
  `PESO` float(4,2) DEFAULT NULL,
  `DIR_CARTEIRINHA` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `animal` (`ID_PET`, `FK_PASSAGEM`, `DATA_NASC_PET`, `PESO`, `DIR_CARTEIRINHA`) VALUES
(1, 1, '2020-06-03', 9.00, NULL),
(2, 2, '2022-06-02', 6.00, NULL),
(3, 8, '2021-06-01', 7.00, NULL),
(5, 11, '2020-01-01', 5.00, '../../images/imgpet/6478d1b472a1e.jpg');
...
(8, 'emily-dacosta97@itelefonica.com.br', '202cb962ac59075b964b07152d234b70', '2023-05-18 14:20:51', NULL),
(9, 'jhordy570@gmail.com', '401cec94d3ed586d8cb895c10c0f7db6', '2023-05-25 14:21:48', NULL);
...
INSERT INTO `cupom` (`ID_CUPOM`, `CODIGO_CUPOM`, `VALOR_DESCONTO`, `CRIADO`, `MODIFICADO`) VALUES
(1, 'ABC123', 10, '2023-05-04 17:10:09', NULL),
(2, 'ZXY789', 15, '2023-05-04 17:10:09', NULL),
(3, 'BAG420', 30, '2023-05-04 17:10:09', NULL),
(4, 'VOO666', 20, '2023-05-04 17:10:09', NULL);
...
(9, '73081665', 'QMS 11', '123', 'Setor de Mansões de Sobradinho', 'Brasília', 'DF', 'A', NULL),
(10, '73081665', 'QMS 11', '123', 'Setor de Mansões de Sobradinho', 'Brasília', 'DF', 'A', NULL),
(11, '69911140', 'Rua 15', '264', 'Glória', 'Rio Branco', 'AC', 'apartamento', NULL),
(12, '69911140', 'Rua 15', '264', 'Glória', 'Rio Branco', 'AC', 'apartamento', NULL);
...
INSERT INTO `pagamento` (`ID_PAGAMENTO`, `STATUS_PAGAMENTO`, `DATA_PAGAMENTO`, `TIPO_PAGAMENTO`, `FK_RESERVA`, `PARCELAS`) VALUES
(1, 'Aprovado', '2023-05-18 14:30:05', 'Boleto', 4, NULL),
(2, 'Aprovado', '2023-05-18 16:22:25', 'Boleto', 5, NULL);
...
INSERT INTO `passageiro` (`ID_PASSAGEIRO`, `NOME_PASSAGEIRO`, `SOBRENOME_PASSAGEIRO`, `EMAIL_PASSAGEIRO`, `CPF_PASSAGEIRO`, `DATA_NASC_PASSAGEIRO`, `FK_TELEFONE`) VALUES
(1, 'Breno', 'Silva', 'breno@gmail.com', '11144477735', '1961-04-01', 1),
(2, 'Paulo', 'Miklos', 'pmiklos@gmail.com', '34767980038', '1959-01-21', 3),
(3, 'Friedrich', 'Nietzsche', 'ubermensch@gmail.com', '75331671047', '2001-10-15', 4),
(4, 'Fulano', 'dos Santos', 'fulano@gmail.com', '01810413087', '2023-11-19', 5),
(5, 'Ryan', 'Nayr Norama', 'emily-dacosta97@itelefonica.com.br', '78829097268', '2023-05-17', 7),
(6, 'dfjhgid', 'khsdkfhskjdh', 'ryansantosn@gmail.com', '62492038696', '2023-05-06', 8),
(7, 'dfgbuidhg', 'jigsdkjfjghskghd', 'ryan@senaisp.edu.br', '13464267679', '2023-05-05', 9),
(8, 'difghd', 'ishdlffh', 'francisco.jose.jesus@cssmi.com.br', '50838316271', '2016-02-09', 2),
(9, 'fghiolHOLKFJDAH', 'dkjflfkdjghldk', 'gabrielenriconascimento@outlook.com.br', '52252563338', '2009-06-03', 2),
(10, 'dhiugio', 'oihsdoifuh', 'dsifs@gmail.com', '45051040527', '2022-02-09', 2),
(11, 'sdiuhf', 'kjshbdlkfjslk', 'jdfgjh@fdhg.com', '31736580191', '2022-02-02', 2),
(12, 'dfgu', 'khsdgkfjh', 'sdhgfbj@idf.com', '14825455000', '2022-02-01', 2),
(13, 'ufdgsjf', 'jhgsjdg', 'fdghj@kdjhg.com', '38815984640', '2022-02-01', 2),
(14, 'sdgfv', 'iugsi', 'sdh@kdjhf.com', '35017924760', '2001-01-01', 2),
(15, 'ksdh', 'kshdkfjh', 'ksdhbk@kjdhfk.com', '77030137574', '2005-01-01', 2),
(16, 'idsgh', 'khskjdh', 'dfkjnh@lkdf.com', '48783860452', '2001-01-01', 2);
...
CREATE TABLE `reserva` (
  ...
  `MOTIVO_STATUS` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `reserva` (`ID_RESERVA`, `STATUS_RESERVA`, `VALOR_TOTAL`, `DATA_RESERVA`, `DATA_STATUS`, `FK_USUARIO`, `MOTIVO_STATUS`) VALUES
(1, 'Cancelada', '7200.00', '2023-05-04 17:10:09', '2023-05-04 17:10:09', 1, NULL),
(2, 'Cancelada', '8000.00', '2023-05-05 19:09:02', '2023-05-05 19:09:02', 7, NULL),
(3, 'Cancelada', '4000.00', '2023-05-18 14:26:50', '2023-05-18 14:26:50', 8, NULL),
(4, 'Cancelada', '4000.00', '2023-05-18 14:29:57', '2023-05-18 14:29:57', 8, NULL),
(5, 'Cancelada', '4000.00', '2023-05-18 16:22:21', '2023-05-18 16:22:21', 8, NULL),
(6, 'Cancelada', '7599.98', '2023-05-18 17:00:39', '2023-05-18 17:00:39', 8, NULL),
(7, 'Cancelada', '2999.99', '2023-06-01 14:10:12', '2023-06-01 14:10:12', 1, NULL),
(8, 'Cancelada', '2999.99', '2023-06-01 14:10:54', '2023-06-01 14:10:54', 1, NULL),
(9, 'Cancelada', '2999.99', '2023-06-01 14:13:05', '2023-06-01 14:13:05', 1, NULL),
(10, 'Cancelada', '8999.98', '2023-06-01 14:21:17', '2023-06-01 14:21:17', 1, NULL),
(11, 'Cancelada', '8999.98', '2023-06-01 14:25:26', '2023-06-01 14:25:26', 1, NULL),
(12, 'Cancelada', '5999.98', '2023-06-01 14:29:04', '2023-06-01 14:29:04', 1, NULL),
(13, 'Cancelada', '8999.98', '2023-06-01 14:30:48', '2023-06-01 14:30:48', 1, NULL),
(14, 'Pendente', '8999.98', '2023-06-01 14:35:07', '2023-06-01 14:35:07', 1, NULL),
(15, 'Pendente', '8999.98', '2023-06-01 14:35:39', '2023-06-01 14:35:39', 1, NULL);
...
(8, '436129358', '2023-05-05'),
(9, '440570165', '2016-10-12');
...
(5, '11', '444444444', NULL),
(6, '55', '992920273', NULL),
(7, '55', '(61) 9929', '2023-05-18 14:29:57'),
(8, '11', '987654213', '2023-05-18 17:00:39'),
(9, '11', '987654321', '2023-05-18 17:00:39'),
(10, '11', '931315093', NULL);
...
(8, 'Emily', 'Malu', 'da Costa', '78829097268', '2023-05-17', 8, 8, 6, 10, '2023-05-18 14:20:51', '2023-05-18 14:30:39'),
(9, 'jhordy', 'Alexis', 'De la Cruz', '60253099064', '1998-04-07', 9, 9, 10, 12, '2023-05-25 14:21:48', NULL);
...
--
ALTER TABLE `passageiro`
  MODIFY `ID_PASSAGEIRO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de tabela `passagem`
--
ALTER TABLE `passagem`
  MODIFY `ID_PASSAGEM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `rg`
  MODIFY `ID_RG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `animal`
  ADD CONSTRAINT `animal_ibfk_1` FOREIGN KEY (`FK_PASSAGEM`) REFERENCES `passagem` (`ID_PASSAGEM`);
