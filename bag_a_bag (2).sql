...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04-Maio-2023 às 17:22
...
(88, '2023-05-02 15:10:00', '01:00:00', 3),
(89, '2023-05-02 15:10:00', '01:00:00', 3),
(90, '2023-05-02 15:10:00', '01:00:00', 3),
(91, '2023-05-02 15:10:00', '01:00:00', 3),
(92, '2023-05-02 15:10:00', '01:00:00', 3),
(93, '2023-05-02 15:10:00', '01:00:00', 3),
(94, '2023-05-02 15:10:00', '01:00:00', 3),
(95, '2023-05-02 15:10:00', '01:00:00', 3),
(96, '2023-05-02 11:21:00', '11:21:12', 1);
...
(1, 'Breno', 'Silva', 'breno@gmail.com', '11144477735', '1978-04-01', 1, 1),
(2, 'Paulo', 'Miklos', 'pmiklos@gmail.com', '34767980038', '1965-05-01', 4, 1);
...
INSERT INTO `passagem` (`ID_PASSAGEM`, `TIPO_PASSAGEM`, `FK_ASSENTO`, `FK_PASSAGEIRO`, `FK_VOO`, `FK_CUPOM`, `FK_RESERVA`) VALUES
(1, 'Ida e volta', 1, 1, 1, 1, 1),
(2, 'Ida e volta', 2, 2, 1, 2, 1);
...
(1, 'Pendente', '1800.00', '2023-05-04 17:10:09', '2023-05-04 17:10:09', 1);
...
(4, 'Alan', 'Aruanã', 'Gomes', '33687431045', '2000-05-03', 4, 4, 1, 2, '2023-05-04 14:40:43', NULL),
(6, 'Violeta', NULL, 'Araújo', '85692856042', '2000-05-03', 6, 6, 1, 2, '2023-05-04 14:52:58', NULL),
(7, 'Friederich', NULL, 'Nietzsche', '75331671047', '2001-05-04', 7, 7, 4, 8, '2023-05-04 15:06:56', NULL);
...
--
ALTER TABLE `passageiro`
  MODIFY `ID_PASSAGEIRO` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de tabela `passagem`
--
ALTER TABLE `passagem`
  MODIFY `ID_PASSAGEM` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
